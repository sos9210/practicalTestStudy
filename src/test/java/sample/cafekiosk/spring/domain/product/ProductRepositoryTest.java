...
class ProductRepositoryTest  extends IntegrationTestSupport {
    ...
    void findAllBySellingStatusIn() {
        ...
        Product product2 = createProduct("002", ProductType.HANDMADE, ProductSellingStatus.SELLING, "카페라떼", 4500);
        ...
        List<Product> products = productRepository
                .findAllBySellingStatusIn(List.of(ProductSellingStatus.SELLING, ProductSellingStatus.HOLD));

        Assertions.assertThat(products).hasSize(2)
                .extracting("productNumber", "name", "sellingStatus")
                .containsExactlyInAnyOrder(
                        Assertions.tuple("001","아메리카노",ProductSellingStatus.SELLING),
                        Assertions.tuple("002","카페라떼",ProductSellingStatus.SELLING)
                );
    }
    ...
    void findAllByProductNumberIn() {
        ...
        //when
        List<Product> products = productRepository
                .findAllByProductNumberIn(List.of("001","002"));
